...
var index$4 = require('../index-22cb6442.js');
...
var schema$j = require('@graphql-tools/schema');
...
for (const key of Object.keys(index$4.colorName)) {
	reverseKeywords[index$4.colorName[key]] = key;
}
...
convert.rgb.keyword = function (rgb) {
	...
	for (const keyword of Object.keys(index$4.colorName)) {
		const value = index$4.colorName[keyword];
...
convert.keyword.rgb = function (keyword) {
	return index$4.colorName[keyword];
};
...
var ansiStyles = index$4.createCommonjsModule(function (module) {
...
var fileResource = /*#__PURE__*/Object.freeze({
	__proto__: null,
	plan: plan,
	validate: validate,
	schema: schema,
...
var directoryResource = /*#__PURE__*/Object.freeze({
	__proto__: null,
	plan: plan$1,
	validate: validate$1,
	schema: schema$1,
...
var gatsbyPageResource = /*#__PURE__*/Object.freeze({
	__proto__: null,
	create: create$2,
	update: update$2,
	read: read$2,
...
var npmPackageResource = /*#__PURE__*/Object.freeze({
	__proto__: null,
...
const fileExists$1 = filePath => fs.existsSync(filePath);
...
var gatsbyPluginResource = /*#__PURE__*/Object.freeze({
	__proto__: null,
...
const fileExists$2 = filePath => fs.existsSync(filePath);
...
var gatsbyShadowFileResource = /*#__PURE__*/Object.freeze({
	__proto__: null,
...
const readConfigFile$1 = async root => {
  ...
  try {
    src = await fs.readFile(getConfigPath$1(root), `utf8`);
  } catch (e) {
    if (e.code === `ENOENT`) {
      src = `/**
 * Configure your Gatsby site with this file.
...
const create$6 = async ({
  ...
  await fs.writeFile(getConfigPath$1(root), code);
...
const destroy$6 = async ({
  ...
  await fs.writeFile(getConfigPath$1(root), newSrc);
};
...
var gatsbySiteMetadataResource = /*#__PURE__*/Object.freeze({
	__proto__: null,
...
var npmPackageScriptResource = /*#__PURE__*/Object.freeze({
	__proto__: null,
	schema: schema$7,
	validate: validate$7,
	all: all$3,
...
var npmPackageJsonResource = /*#__PURE__*/Object.freeze({
	__proto__: null,
	schema: schema$8,
	validate: validate$8,
	plan: plan$8,
...
var gitIgnoreResource = /*#__PURE__*/Object.freeze({
	__proto__: null,
	plan: plan$9,
	validate: validate$9,
	schema: schema$9,
...
var contentfulSpace = /*#__PURE__*/Object.freeze({
	__proto__: null,
	schema: schema$a,
	validate: validate$a,
	plan: plan$a,
...
var contentfulEnvironment = /*#__PURE__*/Object.freeze({
	__proto__: null,
	schema: schema$b,
	validate: validate$b,
	plan: plan$b,
...
var contentfulType = /*#__PURE__*/Object.freeze({
	__proto__: null,
	schema: schema$c,
	validate: validate$c,
	plan: plan$c,
...
var contentfulEntry = /*#__PURE__*/Object.freeze({
	__proto__: null,
	schema: schema$d,
	validate: validate$d,
	plan: plan$d,
...
var scheduler_production_min = index$4.createCommonjsModule(function (module, exports) {
var f,g,h,k,l;
...
var scheduler = index$4.createCommonjsModule(function (module) {
...
var reactReconciler_production_min = index$4.createCommonjsModule(function (module) {
...
var aa=index$4.objectAssign,ba=index$4.react,m=scheduler;function n(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return "Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var p=ba.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
...
var reactReconciler = index$4.createCommonjsModule(function (module) {
...
class ErrorBoundary extends index$4.react.Component {
  constructor(props) {
    super(props);
    this.state = {
      hasError: false
...
const isResource = type => type && (type === `Input` || componentResourceMapping[type]);
...
const transform = (props = {}, type) => {
  ...
  const plan = props.children.filter(Boolean).reduce((acc, curr) => {
    ...
    if (!componentResourceMapping[childType]) {
...
const ParentResourceContext = /*#__PURE__*/index$4.react.createContext({});
const useParentResourceContext = () => {
  const context = index$4.react.useContext(ParentResourceContext);
  return context;
};
const ParentResourceProvider = ({
  ...
  return /*#__PURE__*/index$4.react.createElement(ParentResourceContext.Provider, {
    value: data
  }, children);
};

const StepContext = /*#__PURE__*/index$4.react.createContext({});
const useRecipeStep = () => {
  const context = index$4.react.useContext(StepContext);
  return context;
};
const StepProvider = ({
  step,
  totalSteps,
  children
}) => /*#__PURE__*/index$4.react.createElement(StepContext.Provider, {
  value: {
    step,
    totalSteps
  }
...
const RecipeStep = ({
  ...
  totalSteps,
  children
}) => /*#__PURE__*/index$4.react.createElement(StepProvider, {
  step: step,
...
const GlobalsContext = /*#__PURE__*/index$4.react.createContext({});

const useGlobals = () => index$4.react.useContext(GlobalsContext);
...
const Wrapper = ({
  ...
  queue,
  plan
}) => /*#__PURE__*/index$4.react.createElement(ErrorBoundary, null, /*#__PURE__*/index$4.react.createElement(GlobalsProvider, {
  value: {
...
}, /*#__PURE__*/index$4.react.createElement(index$4.ResourceProvider, {
  value: plan
}, /*#__PURE__*/index$4.react.createElement(index$4.InputProvider, {
  value: inputs
}, /*#__PURE__*/index$4.react.createElement(index$4.react.Suspense, {
  fallback: /*#__PURE__*/index$4.react.createElement("p", null, "Loading recipe 1/2...")
}, children)))));
...
const ResourceComponent = ({
  ...
  return /*#__PURE__*/index$4.react.createElement(ParentResourceProvider, {
    data: {
      [Resource]: resourceData
    }
  }, /*#__PURE__*/index$4.react.createElement(Resource, null, JSON.stringify({ ...resourceData,
    _props: props,
    _stepMetadata: step,
    _uuid,
    _type
...
const validateResource = (resourceName, context, props) => {
  ...
  const {
    error
  } = componentResourceMapping[resourceName].validate(userProps);
...
const handleResource = (resourceName, context, props) => {
  ...
  const allResources = index$4.useResourceContext();
  ...
  try {
    promise = new Promise((resolve, reject) => {
      ...
      if (cachedValue) {
        ...
        componentResourceMapping[resourceName][fn](context, props).then(result => {
          if (fn === `create`) {
            result.isDone = true;
          }
...
const render = (recipe, cb, context = {}, isApply, isStream, name) => {
  ...
  let result;
  let resourcesArray = [];
  const recipeWithWrapper = /*#__PURE__*/index$4.react.createElement(Wrapper, {
    inputs: inputs,
    plan: context.plan,
    isApply: isApply,
...
const resourceComponents = Object.keys(componentResourceMapping).reduce((acc, resourceName) => {
  acc[resourceName] = props => /*#__PURE__*/index$4.react.createElement(index$4.react.Suspense, {
    fallback: /*#__PURE__*/index$4.react.createElement("p", null, "Reading ", resourceName, "...")
  }, /*#__PURE__*/index$4.react.createElement(ResourceComponent, index$4._extends({
...
var html = index$4.createCommonjsModule(function (module, exports) {
...
var _default = index$4.createCommonjsModule(function (module, exports) {
...
var foreignContent = index$4.createCommonjsModule(function (module, exports) {
...
var unistUtilPosition = index$4.createCommonjsModule(function (module, exports) {
/* Expose. */
...
function merge(definitions) {
  ...
  return new schema$e(immutable.apply(null, property), immutable.apply(null, normal), space);
}
...
var create_1 = create$e;

function create$e(definition) {
  ...
  return new schema$e(property, normal, space);
}
...
var schema$f = Schema$1;
var proto$3 = Schema$1.prototype;
proto$3.space = null;
proto$3.normal = {};
proto$3.property = {};
...
function merge$1(definitions) {
  ...
  return new schema$f(immutable.apply(null, property), immutable.apply(null, normal), space);
}
...
var info$1 = Info$1;
var proto$4 = Info$1.prototype;
proto$4.space = null;
proto$4.attribute = null;
proto$4.property = null;
proto$4.boolean = false;
proto$4.booleanish = false;
proto$4.overloadedBoolean = false;
proto$4.number = false;
proto$4.commaSeparated = false;
proto$4.spaceSeparated = false;
proto$4.commaOrSpaceSeparated = false;
proto$4.mustUseProperty = false;
proto$4.defined = false;
...
var create_1$1 = create$f;

function create$f(definition) {
  var space = definition.space;
  var mustUseProperty = definition.mustUseProperty || [];
  var attributes = definition.attributes || {};
  var props = definition.properties;
  ...
  return new schema$f(property, normal, space);
}
...
var trim_1 = index$4.createCommonjsModule(function (module, exports) {
...
var caseSensitive = index$4.getCjsExportFromNamespace(svgCaseSensitiveTagNames$1);
...
var ns = index$4.getCjsExportFromNamespace(webNamespaces);
...
var schema$g = Schema$2;
var proto$5 = Schema$2.prototype;
proto$5.space = null;
proto$5.normal = {};
proto$5.property = {};
...
function merge$2(definitions) {
  ...
  return new schema$g(immutable.apply(null, property), immutable.apply(null, normal), space);
}
...
var create_1$2 = create$g;

function create$g(definition) {
  var space = definition.space;
  var mustUseProperty = definition.mustUseProperty || [];
  var attributes = definition.attributes || {};
  var props = definition.properties;
  ...
  return new schema$g(property, normal, space);
}
...
var schema$h = Schema$3;
var proto$7 = Schema$3.prototype;
proto$7.space = null;
proto$7.normal = {};
proto$7.property = {};
...
function merge$3(definitions) {
  ...
  return new schema$h(immutable.apply(null, property), immutable.apply(null, normal), space);
}
...
var info$3 = Info$3;
var proto$8 = Info$3.prototype;
proto$8.space = null;
proto$8.attribute = null;
proto$8.property = null;
proto$8.boolean = false;
proto$8.booleanish = false;
proto$8.overloadedBoolean = false;
proto$8.number = false;
proto$8.commaSeparated = false;
proto$8.spaceSeparated = false;
proto$8.commaOrSpaceSeparated = false;
proto$8.mustUseProperty = false;
proto$8.defined = false;
...
var create_1$3 = create$h;

function create$h(definition) {
  var space = definition.space;
  var mustUseProperty = definition.mustUseProperty || [];
  var attributes = definition.attributes || {};
  var props = definition.properties;
  ...
  return new schema$h(property, normal, space);
}
...
var hastToReact$2 = index$4.getCjsExportFromNamespace(hastToReact$1);
...
function toH(h, node, ctx) {
  ...
  if (typeof attributes.style === 'string' && (ctx.vdom === true || ctx.vue === true || ctx.react === true)) {
    ...
    attributes.style = parseStyle$1(attributes.style, name);
  }
...
function parseStyle$1(value, tagName) {
  var result = {};
...
var voids = index$4.getCjsExportFromNamespace(htmlVoidElements);
...
var freeGlobal = typeof index$4.commonjsGlobal == 'object' && index$4.commonjsGlobal && index$4.commonjsGlobal.Object === Object && index$4.commonjsGlobal;
...
var entities = index$4.getCjsExportFromNamespace(characterEntitiesHtml4);

var legacy = index$4.getCjsExportFromNamespace(characterEntitiesLegacy);

var dangerous$2 = index$4.getCjsExportFromNamespace(dangerous$1);
...
var lib$1 = index$4.createCommonjsModule(function (module, exports) {
...
var lib$2 = index$4.createCommonjsModule(function (module, exports) {
...
var mdxHastToJsx = index$4.createCommonjsModule(function (module, exports) {
const {
  transformSync
} = core__default;
...
var mdx = index$4.createCommonjsModule(function (module, exports) {
const DEFAULT_OPTIONS = {
  remarkPlugins: [],
  rehypePlugins: [],
  compilers: []
...
const scope = {
  ...
  RecipeIntroduction,
  Input,
  useInput: index$4.useInput,
  useInputByKey: index$4.useInputByKey,
  useResource: index$4.useResource,
  useProvider: index$4.useProvider,
  Config: `div`,
  // Keep this as a noop for now
  ...resourceComponents,
  mdx: index$4.react.createElement,
  MDXContent: index$4.react.createElement
};
...
function createTypes() {
  const resourceTypes = Object.entries(componentResourceMapping).map(([resourceName, resource]) => {
    if (!resource.schema) {
      return undefined;
    }
...
const schema$i = new TypeDictionary.GraphQLSchema({
  query: rootQueryType,
...
server.listen(PORT, () => {
  new index$4.dist.SubscriptionServer({
